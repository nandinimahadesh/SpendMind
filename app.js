...
(function () {
  ...
  const EMOJI_MAP = [
    // Food variants — specific first
    { keys: ['food - pg','food pg','pg food'], emoji: '🍽️' },
    ...
    { keys: ['lunch'], emoji: '🥗' },
    { keys: ['dinner'], emoji: '🍛' },
    { keys: ['breakfast'], emoji: '🥞' },
    { keys: ['snack','chips','biscuit'], emoji: '🍿' },
    { keys: ['eat','meal','restaurant','biryani','thali'], emoji: '🍴' },
    { keys: ['pizza','burger','fast food','junk'], emoji: '🍕' },
    { keys: ['ice cream','dessert','cake','sweets','mithai'], emoji: '🍰' },
    { keys: ['juice','smoothie','shake'], emoji: '🧃' },
    // People
    { keys: ['mom','mum','mother','amma'], emoji: '🫶' },
    { keys: ['dad','papa','father','appa'], emoji: '👨‍👩‍👧' },
    { keys: ['family','parents','home transfer'], emoji: '🏡' },
    { keys: ['friend','friends','gang','crew'], emoji: '👯' },
    { keys: ['sibling','brother','sister','bro','sis'], emoji: '👫' },
    { keys: ['boyfriend','girlfriend','partner','bae','date'], emoji: '💑' },
    // Groceries & household
    { keys: ['grocery','groceries','supermarket','vegetables','fruits','bigbasket','zepto','blinkit'], emoji: '🛒' },
    { keys: ['kitchen','utensil','vessel','home supplies'], emoji: '🍳' },
    { keys: ['cleaning','maid','housekeeping','laundry','wash'], emoji: '🧹' },
    // Drinks
    { keys: ['coffee','cafe','starbucks','ccd','third wave'], emoji: '☕' },
    { keys: ['tea','chai','chaiwala'], emoji: '🍵' },
    { keys: ['drink','bar','alcohol','beer','wine','pub','nightout','night out','cocktail'], emoji: '🍻' },
    { keys: ['water','mineral water'], emoji: '💧' },
    // Transport
    { keys: ['metro','subway','train','transit'], emoji: '🚇' },
    { keys: ['auto','rickshaw'], emoji: '🛺' },
    { keys: ['cab','taxi','uber','ola','rapido'], emoji: '🚗' },
    { keys: ['bus','local','public transport','commute'], emoji: '🚌' },
    { keys: ['bike','two wheeler','scooty','cycle'], emoji: '🏍️' },
    { keys: ['flight','airline','airport'], emoji: '✈️' },
    { keys: ['train travel','irctc'], emoji: '🚆' },
    { keys: ['petrol','fuel','pump'], emoji: '⛽' },
    { keys: ['parking'], emoji: '🅿️' },
    { keys: ['toll','highway'], emoji: '🛣️' },
    // Shopping
    { keys: ['shopping','amazon','flipkart','order','online'], emoji: '📦' },
    { keys: ['myntra','ajio','fashion','clothes','clothing','outfit','dress','kurta'], emoji: '👗' },
    { keys: ['shoes','footwear','sneakers','heels'], emoji: '👟' },
    { keys: ['accessories','jewellery','jewelry','watch','bag','purse'], emoji: '💍' },
    { keys: ['nykaa','beauty','makeup','cosmetics','lipstick'], emoji: '💄' },
    { keys: ['meesho','thrift'], emoji: '🏷️' },
    // Tech
    { keys: ['subscription','netflix','hotstar','prime','spotify','youtube','zee5','streaming'], emoji: '📺' },
    { keys: ['app','software','saas','plugin','tool'], emoji: '📱' },
    { keys: ['laptop','computer','gadget','device','iphone','phone purchase'], emoji: '💻' },
    { keys: ['mobile','recharge','sim','data plan'], emoji: '📲' },
    { keys: ['internet','wifi','broadband'], emoji: '📡' },
    // Entertainment
    { keys: ['movie','film','theatre','pvr','inox','cinema'], emoji: '🎬' },
    { keys: ['concert','show','event','gig','performance'], emoji: '🎵' },
    { keys: ['gaming','game','playstation','xbox','steam'], emoji: '🎮' },
    { keys: ['outing','hangout','fun','leisure'], emoji: '🎉' },
    { keys: ['sport','cricket','football','badminton','match'], emoji: '🏏' },
    { keys: ['comedy','standup'], emoji: '😂' },
    // Health & fitness
    { keys: ['gym','fitness','workout','crossfit'], emoji: '🏋️' },
    { keys: ['yoga','meditation','mindfulness'], emoji: '🧘' },
    { keys: ['doctor','clinic','hospital','consultation'], emoji: '🏥' },
    { keys: ['medicine','pharmacy','chemist','tablet','medical'], emoji: '💊' },
    { keys: ['skincare','moisturizer','serum','sunscreen'], emoji: '🧴' },
    { keys: ['health','wellness','supplement','protein'], emoji: '🩺' },
    { keys: ['haircut','salon','spa','grooming','parlour'], emoji: '💇' },
    { keys: ['massage'], emoji: '💆' },
    // Finance
    { keys: ['investment','mutual fund','stocks','sip','trading','equity'], emoji: '📈' },
    { keys: ['saving','savings','fd','fixed deposit','rd'], emoji: '🏦' },
    { keys: ['insurance','lic','policy','premium'], emoji: '🛡️' },
    { keys: ['tax','gst','itr','income tax'], emoji: '🧾' },
    { keys: ['loan','emi','credit card bill','cc bill'], emoji: '💳' },
    // Housing & utilities
    { keys: ['rent','pg','room','accommodation','housing'], emoji: '🏠' },
    { keys: ['electricity','light bill','current bill'], emoji: '⚡' },
    { keys: ['water bill','water'], emoji: '💧' },
    { keys: ['gas','lpg','cylinder'], emoji: '🔥' },
    { keys: ['wifi','broadband','jio','airtel','internet bill'], emoji: '📶' },
    { keys: ['maintenance','society','apartment'], emoji: '🏢' },
    // Education
    { keys: ['books','course','udemy','coursera','learning','study'], emoji: '📚' },
    { keys: ['school','college','university','tuition','fees'], emoji: '🎓' },
    { keys: ['stationery','pen','notebook','supplies'], emoji: '✏️' },
    // Income
    { keys: ['salary','stipend','ctc','pay','wage'], emoji: '💼' },
    { keys: ['freelance','consulting','gig','project income'], emoji: '🖥️' },
    { keys: ['reimbursement','refund','claim','expense claim'], emoji: '🔄' },
    { keys: ['gift received','cash gift','gifted'], emoji: '🎀' },
    { keys: ['bonus','incentive','reward'], emoji: '🏅' },
    { keys: ['rent received','rental income'], emoji: '🏘️' },
    // Misc
    { keys: ['travel','trip','vacation','holiday','goa','himachal','europe'], emoji: '🧳' },
    { keys: ['hotel','resort','airbnb','stay'], emoji: '🏨' },
    { keys: ['gift','present','birthday gift'], emoji: '🎁' },
    { keys: ['charity','donation','ngo','social'], emoji: '🤝' },
    { keys: ['dog','cat','pet','vet','animal'], emoji: '🐾' },
    { keys: ['baby','child','kid','diaper'], emoji: '👶' },
    { keys: ['party','celebration','wedding'], emoji: '🥳' },
    { keys: ['photography','camera','photoshoot'], emoji: '📷' },
    { keys: ['misc','other','miscellaneous','general','random'], emoji: '💸' },
    { keys: ['phone','mobile bill','phone bill'], emoji: '📞' },
  ];
